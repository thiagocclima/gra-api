...
import com.texoit.thiago.graapi.controller.MovieController;
...
public class MovieControllerIntegrationTest {
    ...
    public void removeTest() throws Exception {
        mockMvc.perform( MockMvcRequestBuilders.delete("/movie/17").contentType(MediaType.APPLICATION_JSON))
            .andExpect( MockMvcResultMatchers.status().isOk() );
    }
